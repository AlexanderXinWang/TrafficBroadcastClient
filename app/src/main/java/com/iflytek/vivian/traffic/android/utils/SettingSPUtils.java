...
public class SettingSPUtils extends BaseSPUtil {
    ...
    private static volatile com.iflytek.vivian.traffic.android.utils.SettingSPUtils sInstance = null;
     ...
     * @return
     */
    public static com.iflytek.vivian.traffic.android.utils.SettingSPUtils getInstance() {
        if (sInstance == null) {
            synchronized (com.iflytek.vivian.traffic.android.utils.SettingSPUtils.class) {
                if (sInstance == null) {
                    sInstance = new com.iflytek.vivian.traffic.android.utils.SettingSPUtils(XUtil.getContext());
                }
            }
        }
        return sInstance;
